...
INSERT INTO `auth_assignment` (`item_name`,`user_id`,`created_at`) VALUES 
 ...
 (1,'Project','Project'),
 (2,'Activity','Activity');
 INSERT INTO `project` (`id`,`name`,`code`,`client`,`state`,`description`,`parent_project_id`,`requested_user_id`,`approved_ddg_user_id`,`approved_dh_user_id`,`project_type_id`,`division_id`) VALUES 
 (1,'Project 1','p1','client','pending','Description',NULL,2,NULL,NULL,1,NULL),
 (2,'Project 2','p2','client2','pending','Description',NULL,2,NULL,NULL,2,NULL),
 (3,'Project 1.1','p1.1','client','pending','Description',1,2,NULL,NULL,1,NULL);
