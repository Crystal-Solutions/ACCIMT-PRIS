...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2015 at 06:25 PM
...
('add-report', 1, 'allows sectional users to add sectional inputs', NULL, NULL, NULL, NULL),
...
('divisional-head', 1, 'allows divisional head to approve projects and approve project updates + create project and update', NULL, NULL, NULL, NULL),
...
('system-admin', 1, 'system admin can create divisions, create users and change user access level', NULL, NULL, NULL, NULL),
...
INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `created_at`, `updated_at`, `name`, `edf_no`) VALUES
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `edf_no_UNIQUE` (`edf_no`);
